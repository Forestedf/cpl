...
data:
  ...
  bundledCode: "#line 1 \"number_theory/test/convolution_mod.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/convolution_mod\"\n\n#define FAST_IO\n\n#line\
    ...
    \n#line 7 \"number_theory/test/convolution_mod.test.cpp\"\n\nint main() {\n  \
  ...
  requiredBy: []
  timestamp: '2022-08-25 20:06:19+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: number_theory/test/convolution_mod.test.cpp
layout: document
redirect_from:
- /verify/number_theory/test/convolution_mod.test.cpp
- /verify/number_theory/test/convolution_mod.test.cpp.html
