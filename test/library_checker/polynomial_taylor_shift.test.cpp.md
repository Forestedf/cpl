...
data:
  ...
  bundledCode: "#line 1 \"test/library_checker/polynomial_taylor_shift.test.cpp\"\n\
    ...
    \      h[i] *= binom.inv_fact(i);\n    }\n    return h;\n}\n#line 9 \"test/library_checker/polynomial_taylor_shift.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/library_checker/polynomial_taylor_shift.test.cpp
- /verify/test/library_checker/polynomial_taylor_shift.test.cpp.html
