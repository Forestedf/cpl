...
data:
  ...
  bundledCode: "#line 1 \"polynomial/test/pow_of_formal_power_series.test.cpp\"\n\
    ...
    }\n#line 8 \"polynomial/test/pow_of_formal_power_series.test.cpp\"\n\nint main()\
  ...
  verifiedWith: []
documentation_of: polynomial/test/pow_of_formal_power_series.test.cpp
layout: document
redirect_from:
- /verify/polynomial/test/pow_of_formal_power_series.test.cpp
- /verify/polynomial/test/pow_of_formal_power_series.test.cpp.html
