...
data:
  ...
  bundledCode: "#line 1 \"data_structure/test/point_add_range_sum.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\n\n#define FAST_IO\n\
    ...
    \ = FenwickTree<Add<T>>;\n#line 7 \"data_structure/test/point_add_range_sum.test.cpp\"\
    \n\nint main() {\n    i32 n, q;\n    cin >> n >> q;\n    FenwickTree<Add<i64>>\
    \ ft(n);\n    REP(i, n) {\n        i64 a;\n        cin >> a;\n        ft.add(i,\
    \ a);\n    }\n    REP(qi, q) {\n        i32 type;\n        cin >> type;\n    \
    \    if (type == 0) {\n            i32 p;\n            i64 x;\n            cin\
  ...
  verifiedWith: []
documentation_of: data_structure/test/point_add_range_sum.test.cpp
layout: document
redirect_from:
- /verify/data_structure/test/point_add_range_sum.test.cpp
- /verify/data_structure/test/point_add_range_sum.test.cpp.html
